...
export type Organization = Node & Actor & PackageOwner & ProjectOwner & RepositoryDiscussionAuthor & RepositoryDiscussionCommentAuthor & RepositoryOwner & UniformResourceLocatable & MemberStatusable & ProfileOwner & Sponsorable & {
...
export type User = Node & Actor & PackageOwner & ProjectOwner & RepositoryDiscussionAuthor & RepositoryDiscussionCommentAuthor & RepositoryOwner & UniformResourceLocatable & ProfileOwner & Sponsorable & {
  __typename?: 'User';
  /** Determine if this repository owner has any items that can be pinned to their profile. */
  anyPinnableItems: Scalars['Boolean'];
  ...
  & { user?: Maybe<(
    ...
    & { repositories: (
      ...
      & { edges?: Maybe<Array<Maybe<(
        ...
        & { node?: Maybe<(
          { __typename?: 'Repository' }
          & Pick<Repository, 'id' | 'name' | 'url' | 'viewerHasStarred'>
        )> }
      )>>> }
    ) }
  )> }
